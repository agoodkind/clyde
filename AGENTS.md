...
- Use `docs/conversations.md` for durable conversation model, compaction segment, and export selector terminology, and `docs/conversations/debugging.md` for the conversation ingest debugging surface inventory.
