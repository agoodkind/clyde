...
<<<<<<< HEAD
||||||| parent of a8b499e4 (Reference HooksForClient in the registry shim)
...
=======
	...
	_ = (*rawCursorHookHandler).setInt
	_ = (*rawCursorHookHandler).setBool
	_ = Registry{}.InstallsForClient
	_ = Registry{}.ClydeCommandSignatures
)
...
func init() {
	...
	_ = err
>>>>>>> 86f605bf (Fix hookspec sentinel pointer method references)
>>>>>>> a8b499e4 (Reference HooksForClient in the registry shim)
