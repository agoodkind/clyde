...
// Usage is the authoritative live context-usage answer for this
// session. The embedded Snapshot carries the provider-neutral shape; CapturedAt and Source are layer metadata so
...
// as the provider's context usage view reports them. This is what
// compact trims.
...
// stable category names the provider emits in its context usage
// payload.
